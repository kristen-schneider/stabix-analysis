...
def main():
    ...
    for f in files:
        tabix_gene_times, tabix_gene_records, tabix_gene_pval_hits = (
            pltut.read_genes(tabix_out_dir + f + f'_{name}.txt', False))
    ...
    # for comp_f in compressed_files:
    #     # get the gene times


    # plot the file sizes
    # pubplt.plot_scatter_sizes(compressed_files,
    #                           out)
    pubplt.plot_bar_sizes(compressed_files,
                          out)

    pubplt.plot_all_files_gene_times(all_gene_times,
                           all_gene_records,
                           all_gene_pval_hits,
                           all_genomic_indexes,
                           compressed_files,
